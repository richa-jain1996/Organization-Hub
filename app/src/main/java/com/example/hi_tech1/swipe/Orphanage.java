...
public class Orphanage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Orphanage.this, List.class);
                startActivity(i);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Orphanage.this,Regestration.class);
            ...
            public void onClick(View v) {
                ...
                if (!validateContact(editText4.getText().toString())) {
                    ...
                    if (editText2.getText().toString().equals("") || editText8.getText().toString().equals("") || editText4.getText().toString().equals("") || editText5.getText().toString().equals("") || editText6.getText().toString().equals("")) {
                        Toast.makeText(Orphanage.this, "Please enter the details", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                else
                {
                    ...
                    if (isInserted == true)
                        Toast.makeText(Orphanage.this, "DATA ADDED!", Toast.LENGTH_LONG).show();
                    else
                    { if(isInserted == false)
                        Toast.makeText(Orphanage.this, "DATA CANNOT BE ADDED!", Toast.LENGTH_LONG).show();
                    }}}
        });}
    ...
    public void Delete()
    {
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(res==true)
                    Toast.makeText(Orphanage.this, "DATA DELETED!", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(Orphanage.this,"DATA CANNOT BE DELETED!",Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                while(cursor.moveToNext())
                {
                    ...
                    buffer.append("Orphanage Name   : "+cursor.getString(1)+"\n");
    ...
    public void UpdateData()
    {
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res == true)
                    Toast.makeText(Orphanage.this, "DATA UPDATED!", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(Orphanage.this, "DATA CANNOT BE UPDATED!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            case R.id.item1:
                Intent i=new Intent(Orphanage.this,HomePage.class);
                startActivity(i);
                Toast.makeText(Orphanage.this,"WELCOME",Toast.LENGTH_LONG).show();
                break;

            case R.id.item2:
                Intent i2=new Intent(Orphanage.this,About.class);
                startActivity(i2);
                Toast.makeText(Orphanage.this,"About",Toast.LENGTH_SHORT).show();
                break;
            case R.id.item3:
                Intent i3=new Intent(Orphanage.this,Feedback.class);
                startActivity(i3);
                Toast.makeText(Orphanage.this,"Feedback",Toast.LENGTH_LONG).show();
                break;
