...
public class AdminWork extends AppCompatActivity {
    ...
    public EditText editText,editText2,editText4,editText5,editText6,editText8,editText7,editText9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AdminWork.this, List.class);
                startActivity(i);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(AdminWork.this,Regestration.class);
            ...
            public void onClick(View v) {
                ...
                if (!validateContact(editText4.getText().toString())) {
                    ...
                    if (editText2.getText().toString().equals("") || editText8.getText().toString().equals("") || editText4.getText().toString().equals("") || editText5.getText().toString().equals("") || editText6.getText().toString().equals("")) {
                        Toast.makeText(AdminWork.this, "Please enter the details", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                else
                {
                    ...
                    if (isInserted == true)
                        Toast.makeText(AdminWork.this, "DATA ADDED!", Toast.LENGTH_LONG).show();
                    else
                    { if(isInserted == false)
                        Toast.makeText(AdminWork.this, "DATA CANNOT BE ADDED!", Toast.LENGTH_LONG).show();
                    }}}
        });}
    ...
    public void Delete()
    {
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(res==true)
                    Toast.makeText(AdminWork.this, "DATA DELETED!", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(AdminWork.this,"DATA CANNOT BE DELETED!",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void ShowData()
    {
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {    Intent intent=new Intent(AdminWork.this,Display.class);
                    startActivity(intent);
                ...
                while(cursor.moveToNext())
                {
                    ...
                    buffer.append("NGO Name  : "+cursor.getString(1)+"\n");
    ...
    public void UpdateData()
    {
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res == true)
                    Toast.makeText(AdminWork.this, "DATA UPDATED!", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(AdminWork.this, "DATA CANNOT BE UPDATED!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            case R.id.item1:
                Intent i=new Intent(AdminWork.this,HomePage.class);
                startActivity(i);
                Toast.makeText(AdminWork.this,"WELCOME",Toast.LENGTH_LONG).show();
                break;

            case R.id.item2:
                Intent i2=new Intent(AdminWork.this,About.class);
                startActivity(i2);
                Toast.makeText(AdminWork.this,"About",Toast.LENGTH_SHORT).show();
                break;
            case R.id.item3:
                Intent i3=new Intent(AdminWork.this,Feedback.class);
                startActivity(i3);
                Toast.makeText(AdminWork.this,"Feedback",Toast.LENGTH_LONG).show();
                break;
